...
<section class="head">
  <nav>
    <div class="d-flex align-items-center text-center nav">
      ...
      <div class="text-white d-flex justify-content-between gap-3">
        ...
        <div class="boot">
          <h5 class="p-2">
            <a href="caht.php" class="no-underline">Start Your ChatBoot</a>
            <span class="arrow"><i class="fa-solid fa-right-long"></i></span>
          </h5>
        </div>
      </div>
    </div>
    <div class="content d-flex justify-content-md-center mt-5 align-items-center gap-5">
      <div>
        <h1 class="text-white">
      ...
      <div>
        ...
        <div class="mt-3">
          <a href="register.php" class="Get">Get Started for Free</a>
          <a href="#ask" class="Learn">Learn More About Us</a>
        </div>
      </div>
    </div>
  </nav>
...
<section id="topics">
  ...
  <div class="text-center m-5 more">
    <!-- <h3>hello</h3> -->
    <a href="exploer.php" class="">View all <span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
  </div>
</section>
<!--  -->
<section id="health">
  ...
  <div class="row">
    <div class="col-lg-8 col-md-6 col-sm-12 health">
      ...
      <a href="caht.php" class="Start">Start Your ChatBot</a>
      <h5>
        Already a Member? Sign In
        <span class="text-success fw-bold"><a href="#" class="access">Access Your Medical Records</a></span>
      </h5>
    </div>
...
<section id="ai">
  ...
  <div class="header">
    ...
    <div class="d-flex gap-3 ai">
      <a href="#" class="Start">Start Your Journey</a>
      <a href="#" class="Discover">Discover More Benefits</a>
    </div>
  </div>
...
<section id="ask">
  ...
  <div class="container">
    <div class="question d-flex justify-content-between align-items-center p-3 border-bottom">
      <h4>How does Smart Diagnosis work?</h4>
      <i class="fa-solid fa-chevron-down"></i>
    </div>
    <div class="answer-text text-muted mt-3">
      Smart Diagnosis uses AI algorithms to analyze symptoms and suggest possible conditions.
    </div>
    ...
    <div class="answer-text text-muted mt-3">
      Yes, we prioritize your privacy. All personal medical data is encrypted and stored securely, ensuring only authorized professionals can access it.
    </div>
    ...
    <div class="answer-text text-muted mt-3">
      While our tool provides valuable insights, it should not replace professional medical advice. In emergencies, always seek immediate medical attention.
    </div>
    ...
    <div class="answer-text text-muted mt-3">
      We recommend updating your medical history regularly, especially after new treatments, surgeries, or changes in medication to ensure accurate diagnosis.
    </div>
    ...
    <div class="answer-text text-muted mt-3">
      All doctors listed on our platform are licensed professionals with relevant specialties and credentials verified by our team.
    </div>
    ...
    <div class="answer-text text-muted mt-3">
      You can easily contact a doctor through our Contact Doctors page, where you can view their specialties and reach out directly.
    </div>
  </div>
</section>
...
<!--  -->
  ...
  <div class="d-flex justify-content-around contact align-items-center">
    ...
    <form method="POST" action="dev/message/handel_add_message.php">
